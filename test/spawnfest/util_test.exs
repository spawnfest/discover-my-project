defmodule UtilTest do
  ...
  test "Getting commit from string line" do
    string_line =
      "0039d22<->José Valim<->Thu Sep 5 20:03:28 2019 +0200<->Clean up channel state and track duplicate IDs on client"
